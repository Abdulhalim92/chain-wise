...
Документ содержит полное описание проекта ERP-платформы ChainWise: назначение, архитектуру, схемы взаимодействия сервисов, технологии, цепочки запросов/ответов и тестовые сценарии. Исходные требования — в [ChainWise-TZ.md](./ChainWise-TZ.md).
