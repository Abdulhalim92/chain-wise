...
func (x *LoginResponse) GetBranchId() string {
...
type ValidateTokenResponse struct {
	...
	CourierId     *string                `protobuf:"bytes,4,opt,name=courier_id,json=courierId,proto3,oneof" json:"courier_id,omitempty"`
	Permissions   []string               `protobuf:"bytes,5,rep,name=permissions,proto3" json:"permissions,omitempty"`
...
func (x *ValidateTokenResponse) GetCourierId() string {
...
const file_auth_proto_rawDesc = "" +
	...
	"\vpermissions\x18\x05 \x03(\tR\vpermissionsB\f\n" +
	"\n" +
	"_branch_id\",\n" +
	...
	"\n" +
	"courier_id\x18\x04 \x01(\tH\x01R\tcourierId\x88\x01\x01\x12 \n" +
	"\vpermissions\x18\x05 \x03(\tR\vpermissions\x12\x14\n" +
	"\x05valid\x18\x06 \x01(\bR\x05validB\f\n" +
	"\n" +
	"_branch_idB\r\n" +
	"\v_courier_id2\x89\x01\n" +
	"\vAuthService\x120\n" +
